...
\author[1]{Marc Pépino}
\affil[1]{Department of biology, UQTR}
...
library(xtable)
setwd("E:/Phil/Others/Raphe/GTrends/")
#setwd("/media/modelisation/Philippe Massicotte/Phil/Others/Raphe/GTrends/")
countries = read.csv('countries.csv', header = T)
print(xtable(head(countries), caption="Example of country codes."))  
@
...
\begin{center}
\begin{figure}[ht]
\includegraphics[scale = 0.6]{capture.pdf} 
